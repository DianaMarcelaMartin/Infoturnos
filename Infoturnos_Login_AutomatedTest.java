...
//
//		WebElement elemento1 = (new WebDriverWait(driver, 120))
	//			.until(ExpectedConditions.elementToBeClickable(By.id("MenuSuperiorFuncionalidadOrientacion")));                          //Generación Masiva de turnos
//		elemento1.click();
...
//		driver.findElement(By.id("datosGeneracionMasiva:numTurnos")).sendKeys("1");
	...
	//	elemento4.click();
		...
		//
		//			WebElement elemento6 = (new WebDriverWait(driver, 120))
		//				.until(ExpectedConditions.elementToBeClickable(By.id("MenuSuperiorFuncionalidadSucursalClienteAnonimo:anchor")));           //Orientación Sucursal Cliente anonimo
		//			elemento6.click();
		...
		//
		//				WebElement elemento11 = (new WebDriverWait(driver, 120))
		//					.until(ExpectedConditions.elementToBeClickable(By.id("MenuSuperiorFuncionalidadSucursalClienteIdentificado:anchor")));      //Orientación Sucursal Cliente identificado
		//		elemento11.click();
		//
		//				WebElement elemento12 = (new WebDriverWait(driver, 120))
...
//		Select CampoTipoDocumento1 = new Select (elemento21);
	//	CampoTipoDocumento1.selectByVisibleText("Cédula de Ciudadanía");
...
//		elemento36.click();
		...
		CampoTipoDocumento3.selectByVisibleText("Cédula de Ciudadanía");
